...
public class MyApplication {
    ...
    /**
     * Dynamically generates the My Application view for approved candidate
     * applications.
     * 
     * @param approvedApplicationRecords List of maps containing application details
     *                                   fetched from DAO/Controller.
     */
    public static VBox createMyApplicationView(List<Map<String, String>> approvedApplicationRecords) {
        ...
        Text subtitle = new Text(
                "Here you can view candidate applications that have been officially reviewed and approved by administrators.");
        ...
        if (approvedApplicationRecords != null && !approvedApplicationRecords.isEmpty()) {
            for (Map<String, String> app : approvedApplicationRecords) {
                ...
                applicationsList.getChildren()
                        .add(createApplicationCard(orgName, position, submittedDate, approvalDate, themeColor));
            }
        } else {
            ...
            Text emptyText = new Text(
                    "No approved candidate applications found. Applications appear here once approved by an administrator.");
    ...
    private static VBox createApplicationCard(String orgName, String position, String submittedDate,
            String approvalDate, String themeColor) {
