...
public class VoterPage extends VBox {
    ...
    public VoterPage() {
        ...
        getChildren().addAll(
                ...
                filterBar,
                requestSection,
                new Separator() {{ setStyle("-fx-background-color: #cbd5e1; -fx-opacity: 0.6;"); }},
                approvedSection
        );
    ...
    private HBox buildHeader() {
        ...
        Label subtitle = new Label("Review incoming member eligibility requests, verify identities, and manage approved voters");
        ...
        syncBtn.setStyle(FONT + "-fx-background-color: #eff6ff; -fx-text-fill: #1d4ed8; -fx-border-color: #3b82f6; -fx-border-radius: 8; -fx-font-weight: 800; -fx-font-size: 11.5px; -fx-padding: 6 14; -fx-background-radius: 8; -fx-cursor: hand;");
    ...
    private HBox buildFilterBar() {
        ...
        filterBar.setStyle("-fx-background-color: #ffffff; -fx-background-radius: 12; -fx-border-color: #818cf8; -fx-border-radius: 12; -fx-border-width: 1.5; -fx-effect: dropshadow(gaussian, rgba(99,102,241,0.08), 10, 0, 0, 2);");
    ...
    private VBox buildRequestSection() {
        ...
        requestCount.setStyle(FONT + "-fx-text-fill: #4338ca; -fx-font-size: 11.5px; -fx-font-weight: 800; -fx-background-color: #e0e7ff; -fx-padding: 3 10; -fx-background-radius: 12;");
    ...
    private VBox buildApprovedSection() {
        ...
        verifiedBadge.setStyle(FONT + "-fx-background-color: #ecfdf5; -fx-text-fill: #047857; -fx-font-weight: 800; -fx-font-size: 10px; -fx-padding: 3 10; -fx-background-radius: 16; -fx-border-color: #10b981; -fx-border-radius: 16;");
    ...
    private void refreshRequests() {
        ...
        if (count == 0) {
            ...
            emptyBox.setStyle("-fx-background-color: #ffffff; -fx-background-radius: 10; -fx-border-color: #e2e8f0; -fx-border-radius: 10; -fx-border-width: 1.2;");
    ...
    private HBox createRequestCard(VoterModel voter) {
        ...
        avatar.setStyle(FONT + "-fx-background-color: #eff6ff; -fx-text-fill: #1d4ed8; -fx-font-size: 15px; -fx-font-weight: 900; -fx-background-radius: 20; -fx-border-color: #bfdbfe; -fx-border-radius: 20; -fx-border-width: 1.2;");
        ...
        view.setStyle(FONT + "-fx-background-color: #eff6ff; -fx-text-fill: #1d4ed8; -fx-border-color: #3b82f6; -fx-border-radius: 6; -fx-font-weight: 800; -fx-font-size: 11px; -fx-padding: 5 10; -fx-background-radius: 6; -fx-cursor: hand;");
        ...
        if ("PENDING".equalsIgnoreCase(voter.status)) {
            ...
            approve.setStyle(FONT + "-fx-background-color: #ecfdf5; -fx-text-fill: #047857; -fx-border-color: #10b981; -fx-border-radius: 6; -fx-font-weight: 800; -fx-font-size: 11px; -fx-padding: 5 10; -fx-background-radius: 6; -fx-cursor: hand;");
            reject.setStyle(FONT + "-fx-background-color: #fef2f2; -fx-text-fill: #b91c1c; -fx-border-color: #ef4444; -fx-border-radius: 6; -fx-font-weight: 800; -fx-font-size: 11px; -fx-padding: 5 10; -fx-background-radius: 6; -fx-cursor: hand;");
    ...
    private HBox createApprovedVoterCard(VoterModel voter) {
        ...
        avatar.setAlignment(Pos.CENTER);
        avatar.setStyle(FONT + "-fx-background-color: #ecfdf5; -fx-text-fill: #047857; -fx-font-size: 14px; -fx-font-weight: 900; -fx-background-radius: 18; -fx-border-color: #a7f3d0; -fx-border-radius: 18; -fx-border-width: 1.2;");
        ...
        status.setStyle(FONT + "-fx-background-color: #f0fdf4; -fx-text-fill: #15803d; -fx-font-weight: 900; -fx-font-size: 9.5px; -fx-padding: 3 8; -fx-background-radius: 14; -fx-border-color: #22c55e; -fx-border-radius: 14; -fx-border-width: 1;");

        Button view = new Button("View");
        view.setStyle(FONT + "-fx-background-color: #eff6ff; -fx-text-fill: #1d4ed8; -fx-border-color: #3b82f6; -fx-border-radius: 6; -fx-font-weight: 800; -fx-font-size: 11px; -fx-padding: 4 10; -fx-background-radius: 6; -fx-cursor: hand;");
        view.setOnAction(e -> showDetails(voter));
    ...
    private void showDetails(VoterModel voter) {
        Dialog<ButtonType> dialog = createBaseDialog("Voter Registration Details", "Verified Member Profile & Membership Information", "👥", "#2563eb", "#eff6ff");
        ...
        profileCard.setStyle("-fx-background-color: #f8fafc; -fx-background-radius: 10; -fx-border-color: #818cf8; -fx-border-radius: 10; -fx-border-width: 1.2;");
        ...
        statusStrip.setStyle("-fx-background-color: #eff6ff; -fx-background-radius: 8; -fx-border-color: #bfdbfe; -fx-border-radius: 8;");
    ...
    private void approveVoter(VoterModel voter) {
        ...
        title.setStyle(FONT + "-fx-font-size: 15px; -fx-font-weight: 900; -fx-text-fill: #064e3b; -fx-text-alignment: CENTER;");

        Label desc = new Label("This member will be issued official voting authorization in Firebase for all organizational elections.");
        desc.setWrapText(true);
        desc.setStyle(FONT + "-fx-font-size: 12px; -fx-text-fill: #64748b; -fx-text-alignment: CENTER; -fx-line-spacing: 1.5px;");
    ...
    private void rejectVoter(VoterModel voter) {
        ...
        title.setWrapText(true);
        title.setStyle(FONT + "-fx-font-size: 15px; -fx-font-weight: 900; -fx-text-fill: #991b1b; -fx-text-alignment: CENTER;");
    ...
    private List<VoterModel> getInitialFallbackData() {
        ...
        list.add(new VoterModel("DOC_001", "VOT001", "Arjun Sharma", "arjun@gmail.com", "9876500001", "Student", "Computer Engineering", "Third Year", "14 Aug 2026", "PENDING"));
        list.add(new VoterModel("DOC_002", "VOT002", "Sneha Patil", "sneha@gmail.com", "9876500002", "Student", "Information Technology", "Third Year", "14 Aug 2026", "PENDING"));
        list.add(new VoterModel("DOC_003", "VOT003", "Dr. Rahul Joshi", "rahul@college.edu", "9876500003", "Faculty", "Information Technology", "Professor", "13 Aug 2026", "PENDING"));
        list.add(new VoterModel("DOC_004", "VOT004", "Priya Kulkarni", "priya@gmail.com", "9876500004", "Student", "Computer Engineering", "Final Year", "12 Aug 2026", "ACCEPTED"));
        list.add(new VoterModel("DOC_005", "VOT005", "Rohit More", "rohit@gmail.com", "9876500005", "Student", "Mechanical Engineering", "Second Year", "11 Aug 2026", "REJECTED"));
        list.add(new VoterModel("DOC_006", "VOT006", "Amit Deshmukh", "amit@college.edu", "9876500006", "Faculty", "Mechanical Engineering", "Assistant Professor", "10 Aug 2026", "ACCEPTED"));
        return list;
    }
    ...
    public static class VoterModel {
        ...
        public VoterModel(String documentId, String id, String name, String email, String phone, String category, String department, String yearOrRole, String date, String status) {
        ...
        public static VoterModel fromFirestoreDocument(String docId, Map<String, Object> data) {
            return new VoterModel(
                    ...
                    (String) data.getOrDefault("joinedAt", LocalDateTime.now().format(DateTimeFormatter.ofPattern("dd MMM yyyy"))),
