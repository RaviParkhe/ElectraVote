...
public class MyOrganization {
    ...
    /**
     * Dynamically generates the My Organizations view using data fetched from your Controller / DAO.
     * @param organizationRecords List of maps or custom Organization model objects containing database data.
     */
    public static VBox createMyOrganizationView(List<Map<String, String>> organizationRecords) {
        ...
        Text subtitle = new Text("Manage your institutional memberships and switch your active voter portal context between organizations.");
        ...
        if (organizationRecords != null && !organizationRecords.isEmpty()) {
            for (Map<String, String> org : organizationRecords) {
                ...
                orgsList.getChildren().add(createOrgCard(orgName, roleMeta, details, themeColor, status, electionsCount));
            }
        } else {
    ...
    private static VBox createOrgCard(String orgName, String roleMeta, String details, String themeColor, String status, String electionsCount) {
