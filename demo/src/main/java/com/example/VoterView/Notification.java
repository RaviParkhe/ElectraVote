...
public class Notification {
    ...
    /**
     * Dynamically generates the Notification view using data fetched from your Controller / DAO.
     * @param notificationRecords List of maps containing notification data (orgName, messageTitle, messageBody, timeAgo, themeColor).
     */
    public static VBox createNotificationView(List<Map<String, String>> notificationRecords) {
        ...
        Text subtitle = new Text("Stay updated with announcements, ballot schedules, and administrative updates from your organizations.");
        ...
        if (notificationRecords != null && !notificationRecords.isEmpty()) {
            for (Map<String, String> notif : notificationRecords) {
                ...
                notificationsList.getChildren().add(createNotificationCard(orgName, messageTitle, messageBody, timeAgo, themeColor));
            }
        } else {
    ...
    private static VBox createNotificationCard(String orgName, String messageTitle, String messageBody, String timeAgo, String themeColor) {
