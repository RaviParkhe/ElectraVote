...
public class ActiveElection {
    ...
    public static VBox createActiveElectionView() {
        ...
        Text subtitle = new Text("Explore ongoing polls and register your candidacy for future elections. Note: Candidacy applications are only open for upcoming elections.");
    ...
    private static VBox createCandidateApplicationForm(String electionTitle) {
        ...
        descArea.setPromptText("Detail your background, qualifications, and manifesto objectives for voters to review...");
        ...
        submitBtn.setOnAction(e -> {
            ...
            // CandidateDAO.submitApplication(electionTitle, name, mobile, email, position, statement, timestamp);

            VBox successView = createApplicationSuccessView(electionTitle, name, mobile, email, position, statement, timestamp);
            VoterDashboard.dashboardCenter.setCenter(successView);
        });

        buttonRow.getChildren().addAll(cancelBtn, submitBtn);

        formCard.getChildren().addAll(headerBox, new Separator(), errorLabel, nameBox, mobileBox, emailBox, posBox, descFieldBox, new Separator(), buttonRow);
    ...
    private static VBox createApplicationSuccessView(String electionTitle, String name, String mobile, String email, String position, String statement, String timestamp) {
        ...
        noticeBox.setStyle("-fx-background-color: #FEF3C7; -fx-background-radius: 8; -fx-border-color: #F59E0B; -fx-border-radius: 8;");
        ...
        Text noticeText = new Text("Your candidacy form has been registered securely. Please wait until an administrator reviews and approves your submission before public ballot listing.");
        ...
        summaryBox.setStyle("-fx-background-color: #F8FAFC; -fx-background-radius: 8; -fx-border-color: " + BORDER + "; -fx-border-radius: 8;");
        ...
        downloadBtn.setOnAction(e -> {
            ...
            fileChooser.setInitialFileName("Candidate_Application_" + electionTitle.replaceAll("[^a-zA-Z0-9]", "_") + ".txt");
        ...
        successCard.getChildren().addAll(headingBox, new Separator(), noticeBox, summaryBox, timeLabel, new Separator(), actionRow);
    ...
    private static HBox createSummaryRow(String label, String value) {
        ...
        // Replaced invalid setMinWidth on text with a fixed layout region control or wrapper constraint
